...
EXTERN ReturnPoint_GetPositionForVoiceServer:QWORD
EXTERN GetPositionForVoiceServer:PROC
...
.code
	...
	intercept_GetPositionForVoiceServer PROC
		lea rcx, [rsp + 40h]
		...
		; rcx = pointer to avatar position
		call GetPositionForVoiceServer
		...
		movups xmmword ptr [rdi+4320h],xmm0 

		jmp ReturnPoint_GetPositionForVoiceServer ; Jump back to where we left off
	intercept_GetPositionForVoiceServer ENDP
end
