...
int main()
{
    ...
    if (true)
    {
        ...
        *((float*)&gravityHack[1]) = 2.0f;
        ...
        WriteProcessMemory(process_info.hProcess, (void*)(base + 0x175580A), gravityHack, sizeof(gravityHack), &written);
        printf("Written to %X: %d bytes\n", base + 0x175580A, written);
       ...
       // WriteProcessMemory(process_info.hProcess, (void*)(base + 0x175589E), collisionHack, sizeof(collisionHack), &written);
        printf("Written to %X: %d bytes\n", base + 0x1755853, written);
        ...
        written = 0;
        WriteProcessMemory(process_info.hProcess, (void*)(base + 0x175589E), freecamHack, sizeof(freecamHack), &written);
        printf("Written to %X: %d bytes\n", base + 0x175589E, written);
        ...
        written = 0;
        WriteProcessMemory(process_info.hProcess, (void*)(base + 0x175AE85), inventoryAlwaysHack, sizeof(inventoryAlwaysHack), &written);
        printf("Written to %X: %d bytes\n", base + 0x175AE85, written);
        ...
        auto telemetryCallerAddress = 0x1166A7B;
        written = 0;
